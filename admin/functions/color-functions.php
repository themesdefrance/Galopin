...
//courtesy of http://stackoverflow.com/questions/5842440/background-image-dark-or-light
function galopin_get_avg_luminance($filename, $num_samples=10) {
	$img = imagecreatefromjpeg($filename);

	$width = min(imagesx($img), 100);
	$height = imagesy($img);
