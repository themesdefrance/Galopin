<?php
class GalopinCalltoAction extends WP_Widget{
	...
	public function __construct(){
		parent::__construct(
			...
			'GalopinCalltoAction',
			__('Galopin - Call to action', 'galopin'),
			array('description'=>__('Add a call to action in the sidebar.', 'galopin'))
		);
	}
	...
	public function form($instance){
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'galopin' ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'description' ); ?>"><?php _e( 'Call to action incentive:', 'galopin' ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link' ); ?>"><?php _e( 'Call to action destination (url):', 'galopin' ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'label' ); ?>"><?php _e( 'Button\'s label:' , 'galopin' ); ?></label> 
...
if (!function_exists('galopin_calltoaction_widget_init')){

	function galopin_calltoaction_widget_init(){
	
		register_widget('GalopinCalltoAction');
	}
}
add_action('widgets_init', 'galopin_calltoaction_widget_init');
